...
class table_tom_yaoyiyao_log extends discuz_table{
	public function __construct() {
        parent::__construct();
		$this->_table = 'tom_yaoyiyao_log';
		$this->_pk    = 'id';
	}
    ...
    public function delete_by_condition($condition) {
		return DB::query("DELETE FROM %t WHERE 1 %i LIMIT 1 ", array($this->_table, $condition));
	}
